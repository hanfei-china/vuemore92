...
> 百度一下，你的手机是如何去启动开发者选项。

找到**手机的设置，开发者选项，显示布局边界**，选择开启后再去查看APP整体布局边界，这样所有应用控件布局就会一目了然。

![image-20200223143835081](asset/image-20200223143835081.png)

是native APP: 那么每个按钮、文字、图片都是红色的线显示这个控件的布局情况。如下图的微信：
